...
def update_run(
    ...
    rate_receiving_precounted_box: str = Form(default=""),
    rate_receiving_count_per_item: str = Form(default=""),
    rate_storage_cubic_foot: str = Form(default=""),
    ...
    rate_bagging_labeling: str = Form(default=""),
    rate_wholesale: str = Form(default=""),
    rate_pallet_order: str = Form(default=""),
    rate_returns: str = Form(default=""),
    rate_tech_fee: str = Form(default=""),
    rate_customer_service_monthly: str = Form(default=""),
    rate_special_projects: str = Form(default=""),
    ...
    _rate_fields = {
        ...
        "receiving_precounted_box": rate_receiving_precounted_box,
        "receiving_count_per_item": rate_receiving_count_per_item,
        "storage_short_per_pallet_mo": rate_storage,
        "storage_cubic_foot_mo": rate_storage_cubic_foot,
        ...
        "bagging_labeling_per_unit": rate_bagging_labeling,
        "wholesale_per_unit": rate_wholesale,
        "pallet_order_per_pallet": rate_pallet_order,
        "returns_per_unit": rate_returns,
        "monthly_tech_fee": rate_tech_fee,
        "customer_service_monthly": rate_customer_service_monthly,
        "special_projects_per_hour": rate_special_projects,
