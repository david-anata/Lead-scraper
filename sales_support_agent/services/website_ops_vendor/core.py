    ...
    if content_strategy:
        lines.extend(
            [
                ...
                f"- Daily article minimum: `{content_strategy.get('daily_article_minimum', 2)}`",
                f"- Daily article target: `{content_strategy.get('daily_article_target', 3)}`",
