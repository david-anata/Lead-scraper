...
from sales_support_agent.config import Settings, is_active_pipeline_status, normalize_status_key, status_policy_for
...
class ReminderService:
    ...
    def evaluate_lead(
        ...
        *,
        ...
        policy = status_policy_for(status, self.settings.status_policies)
