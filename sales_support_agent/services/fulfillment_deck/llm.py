...
_SYSTEM = (
    ...
    "monthly_order_volume, volume_basis, destinations_note, current_carrier, "
    ...
    "inferred from revenue, never invented. Return volume_basis as the "
    "arithmetic behind the number (e.g. \"74 DTC Shopify + 64 B2B "
    "wholesale\"); empty string when no volume is stated. If sources "
    "conflict, use the most explicit figure and note the conflict in "
    "volume_basis. "
