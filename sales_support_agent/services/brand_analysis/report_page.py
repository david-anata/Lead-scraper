    ...
    body = f"""
      ...
      <div style="display:flex;align-items:center;gap:12px;background:#f0f4ff;border:1px solid #c7d7f8;border-radius:8px;padding:12px 16px;margin-bottom:18px">
        ...
        <div style="flex:1;min-width:0">
          ...
          <span style="color:#475569;font-size:13px;margin-left:4px">Download the intake checklist — a one-page guide covering every file we need and why.</span>
        </div>
        <a href="/static/brand_intake_guide.docx" download="Anata_Brand_Intake_Checklist.docx"
