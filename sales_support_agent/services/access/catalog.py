...
TOOL_CATALOG: tuple[Tool, ...] = (
    ...
    Tool("website_ops.seo", "Overview & Query Map", "Website Ops", ("/admin/website-ops", "/admin/website-ops/queries", "/admin/api/website-ops/run", "/admin/api/website-ops/status"), exact=True),
    ...
    Tool(
        "building.events.manage",
        "Review event dates, holds, and quote readiness",
        "Building",
        (),
    ...
    Tool(
        ...
        "Approve Building agreement packages",
        "Building",
        (),
        any_of=("building.manage",),
    ),
    Tool(
        "building.payments.prepare",
        "Prepare Building payment requests",
        "Building",
        (),
        any_of=("building.manage",),
    ),
