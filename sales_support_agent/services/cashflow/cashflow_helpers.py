...
<html lang="en">
  ...
  <body class="app app--operator app--finance">
    ...
    <div class="finance-draft-status" data-finance-draft-status hidden role="status" aria-live="polite"><span data-finance-draft-message></span><a href="/admin/finances/workspace/review" data-finance-draft-review hidden>Review and save</a></div>
  </body>
</html>"""
