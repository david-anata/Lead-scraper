...
def render_inquiry_workspace(
    *,
    ...
    pricing_section = (
        ...
        f'<tr class="is-total"><td>Total</td><td class="is-num">{_money(totals.get("total_cents"))}</td></tr>'
        f'<tr><td>Deposit due</td><td class="is-num">{_money(totals.get("deposit_cents"))}</td></tr>'
        "</tbody></table>"
