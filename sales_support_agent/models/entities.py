...
class Company(Base):
    ...
    source_system: Mapped[str] = mapped_column(String(64), default="storeleads")
...
class BuildingCampaign(Base):
    ...
    scheduled_by: Mapped[str] = mapped_column(String(255), default="")
    sent_by: Mapped[str] = mapped_column(String(255), default="")
    sent_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    created_by: Mapped[str] = mapped_column(String(255), default="")
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=datetime.utcnow)
