...
class FulfillmentDeckRouteTests(unittest.TestCase):
    ...
    def test_customer_fee_overrides_update_quote_and_margin_review(self) -> None:
        ...
        self.assertIn("Suggested customer price", review.text)
        self.assertIn("Final customer price", review.text)
        self.assertNotIn("<th>Treatment</th>", review.text)
        self.assertIn("Market $2-$3.50", review.text)
        self.assertIn("Sales can match cost to close", review.text)
