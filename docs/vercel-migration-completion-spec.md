...
- QuickBooks callback registration and its real OAuth receipt are closed. The
  production callback remains registered, the verified Anata company returned
  to staging, one-time state validation passed, fresh tokens were stored, and
  no QuickBooks accounting record was changed.
